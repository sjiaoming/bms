...
<script type="text/javascript">
	...
	function search(offset){
		var url = "procurementCheckCSearch.action?pager.offset="+offset;
	...
	function checkPro(){
		...
		var diag = new top.Dialog();
		diag.Title = "审核采购方案";
		diag.URL = "businessManagement/planTrackMg/procurementWay_c_modify.jsp?pids="+tags;
	...
	<input type="hidden" name="resetflag" id="resetflag" value="${resetflag }" />
		<table>
			<tr>
				...
				<td colspan="8">
				<c:if test="${my:method(login.id,'procurementCWayMgr',2)}">
...
<div style="height:35px;">
	<pg:pager items="${pm.total }" url="procurementCheckCSearch.action" export="currentPageNumber=pageNumber" maxPageItems="50" >
