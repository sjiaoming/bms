...
<script type="text/javascript">
	...
	function search(offset){
		var url = "searchGroups.action?pager.offset="+offset;
	...
	function openCheck(groupId){
		...
		diag.Title = "计划分组审核";
		diag.URL = "loadGroup.action?group.id="+groupId;
		diag.Height=480;
		diag.Width=1720;
	...
	<input type="hidden" name="resetflag" id="resetflag" value="${resetflag }" />
		<table>
			<tr>
				...
				<c:if test="${my:method(login.id,'planGroupMgr',1)}">
...
<div style="height:35px;">
	<pg:pager items="${pm.total }" url="searchGroups.action" export="currentPageNumber=pageNumber" maxPageItems="50">
