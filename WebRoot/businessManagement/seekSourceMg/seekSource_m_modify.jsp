...
<div class="box1" panelWidth="1580" panelheight="520">
	<table class="tableStyle">
		...
		<tr>
			...
			<td><span class="text_slice" style="width:80px;" title="${detail.plan.itemsNum }">${detail.plan.itemsNum }</span></td>
		...
		<tr><td colspan="16"></td><td colspan="2"><font color="red">合计：${totalMoney}</font></td></tr>
	</table>
	<table class="tableStyle">
		<tr>
