...
public class KeyGenerator{
	/**
	 * maxCode this is the maxcode query from database;
	 * head is the fix sub string in the maxcode;
	 * numcount is the length of the num partion
	 */
	public static String computeNewCode(String maxCode,String head,int numCount){
